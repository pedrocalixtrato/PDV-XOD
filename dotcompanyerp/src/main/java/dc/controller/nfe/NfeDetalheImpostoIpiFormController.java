...
@Controller
@Scope("prototype")
public class NfeDetalheImpostoIpiFormController extends CRUDFormController<NfeDetalheImpostoIpiEntity> {
	...
	public NfeDetalheImpostoIpiFormController() {
	...
	@Override
	public NfeDetalheImpostoIpiEntity getModelBean() {
