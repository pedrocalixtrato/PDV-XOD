...
@Controller
@Scope("prototype")
public class NfeDetalheImpostoIssqnFormController extends CRUDFormController<NfeDetalheImpostoIssqnEntity> {
	...
	public NfeDetalheImpostoIssqnFormController() {
	...
	@Override
	public NfeDetalheImpostoIssqnEntity getModelBean() {
