...
public class SituacaoDocumentoEntity extends AbstractMultiEmpresaModel<Integer> implements Serializable {
	...
	public SituacaoDocumentoEntity() {

	}

	public SituacaoDocumentoEntity(Integer id) {
		this.id = id;
	}
