...
import dc.controller.ordemservico.CombustivelFormController;
import dc.visao.framework.util.ComponentUtil;

public class CombustivelFormView extends CustomComponent {
	...
	CombustivelFormController controller;
	
	public CombustivelFormView(CombustivelFormController controller) {
		buildMainLayout();
