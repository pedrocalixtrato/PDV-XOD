...
public class SefipCodigoRecolhimentoFormView extends CustomComponent {
	 ...
	 * visual editor.
	 */
	public SefipCodigoRecolhimentoFormView() {
		buildMainLayout();
	...
	private GridLayout buildFields() {
		...
		txtAplicacao.setWidth("700px");
		txtAplicacao.setHeight("-1px");
		txtAplicacao.setSizeFull();
		fields.addComponent(txtAplicacao, 1, 0);
