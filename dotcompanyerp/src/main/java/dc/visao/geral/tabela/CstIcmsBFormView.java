...
import dc.controller.geral.tabela.CstIcmsBFormController;
import dc.visao.framework.util.ComponentUtil;

public class CstIcmsBFormView extends CustomComponent {
	...
	CstIcmsBFormController controller;
	 ...
	 * visual editor.
	 */
	public CstIcmsBFormView(CstIcmsBFormController controller) {
		buildMainLayout();
