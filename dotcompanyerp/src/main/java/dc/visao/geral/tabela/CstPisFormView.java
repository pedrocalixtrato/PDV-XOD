...
import dc.controller.geral.tabela.CstPisFormController;
import dc.visao.framework.util.ComponentUtil;

public class CstPisFormView extends CustomComponent {
	...
	CstPisFormController controller;
	/**
	 ...
	 * visual editor.
	 */
	public CstPisFormView(CstPisFormController controller) {
		buildMainLayout();
