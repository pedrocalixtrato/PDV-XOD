...
import dc.controller.geral.tabela.CstCofinsFormController;
import dc.visao.framework.util.ComponentUtil;

public class CstCofinsFormView extends CustomComponent {
	...
	CstCofinsFormController controller;
	/**
	 ...
	 * visual editor.
	 */
	public CstCofinsFormView(CstCofinsFormController controller) {
		buildMainLayout();
