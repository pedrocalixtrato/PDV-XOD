...
public class CfopFormView extends CustomComponent {
	...
	@AutoGenerated
	private TextArea txtAplicacao ,txtDescricao;
	@AutoGenerated
	...
	private GridLayout buildFields() {
		...
		// txtAplicacao
		txtAplicacao = ComponentUtil.buildTextArea("Aplicação");
		txtAplicacao.setImmediate(false);
		fields.addComponent(txtAplicacao, 0, 2, 1,2);
	...
	public TextArea getTxtAplicacao() {
		return txtAplicacao;
	}

	public void setTxtAplicacao(TextArea txtAplicacao) {
