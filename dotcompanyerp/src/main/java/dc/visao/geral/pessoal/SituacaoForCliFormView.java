...
import dc.controller.geral.pessoal.SituacaoForCliFormController;
import dc.visao.framework.util.ComponentUtil;

public class SituacaoForCliFormView extends CustomComponent {
	...
	SituacaoForCliFormController controller;
	 ...
	 * editor.
	 */
	public SituacaoForCliFormView(SituacaoForCliFormController controller) {
		buildMainLayout();
