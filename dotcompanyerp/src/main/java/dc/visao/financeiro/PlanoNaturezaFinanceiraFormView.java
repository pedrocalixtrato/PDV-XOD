...
import dc.controller.financeiro.PlanoNaturezaFinanceiraFormController;
...
public class PlanoNaturezaFinanceiraFormView extends CustomComponent {
	...
	PlanoNaturezaFinanceiraFormController controller;
	 ...
	 * editor.
	 */
	public PlanoNaturezaFinanceiraFormView(PlanoNaturezaFinanceiraFormController controller) {
		buildMainLayout();
