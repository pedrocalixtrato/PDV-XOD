...
import dc.controller.financeiro.TipoPagamentoFormController;
import dc.entidade.financeiro.TipoPagamento;
import dc.visao.framework.util.ComponentUtil;

public class TipoPagamentoFormView extends CustomComponent {
	...
	TipoPagamentoFormController controller;

	public TipoPagamentoFormView(TipoPagamentoFormController controller) {
		buildMainLayout();
	...
	public void preencheBean(TipoPagamento currentBean) {
		currentBean.setDescricao(getTxtDescricao().getValue());
		currentBean.setTipo(getTxtTipo().getValue());
	}

	public void preencheForm(TipoPagamento currentBean) {
